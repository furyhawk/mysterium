...
- Web search + page fetch are enabled by default so the agent can extend
  the internal findings with up-to-date public information.
...
def _build_research_agent(
    *,
    ...
    Web search + fetch are enabled when ``use_web`` is True (the default) so
    the agent can extend the private RAG findings with public information.
    ...
    return create_deep_agent(
        ...
        # Web tools: search + fetch, independently toggleable.
        web_search=use_web,
        web_fetch=use_web,
...
async def generate_research_report(
    ...
    *,
    ...
    ``use_web`` is True, web search + fetch capabilities. Structured output is
    ...
    Args:
        ...
        use_web: Enable web search/fetch to augment RAG findings.
