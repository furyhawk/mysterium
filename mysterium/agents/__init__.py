...
- Web search + page fetch are enabled by default so the agent can extend
  the internal findings with up-to-date public information. The fetch tool is
  separately toggleable because most Anthropic-compatible gateways reject it.
