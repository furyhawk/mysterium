...
_SYNTHESIS_PHASE = "Synthesizing the final report…"
...
async def stream_research_report(
    ...
    *,
    ...
    yield _progress_phase("Preparing the research agent…", "init")
                    ...
                    async with node.stream(agent_run.ctx) as stream:
                        async for _event in stream:
                            if isinstance(_event, FinalResultEvent):
                                yield _progress_phase(_SYNTHESIS_PHASE, "final_result")
                    ...
                    async with node.stream(agent_run.ctx) as stream:
                        async for event in stream:
                            if isinstance(event, FunctionToolCallEvent):
                                ...
                                if phase:
                                    yield _progress_phase(phase, event.part.tool_name)
